...
class MapControls extends Component {
    ...
    render(){
        return( 
            <> 
                <button onClick={this.move} className={"button " + this.state.move_highlight }  > 
                    <FontAwesomeIcon icon={faArrowsAlt}> </FontAwesomeIcon> 
                </button>
                <button onClick={this.edit} className={"button " + this.state.edit_highlight } > 
                    <FontAwesomeIcon icon={faEdit}> </FontAwesomeIcon> 
                </button>
                <button onClick={this.add} className={"button " + this.state.add_highlight }>
                    <FontAwesomeIcon icon={faMapMarker}> </FontAwesomeIcon> 
                </button>
                <button onClick={this.delete} className={"button " + this.state.delete_highlight } > 
